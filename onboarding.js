    ...
    ov.innerHTML = `
      <div class="oi-modal" role="dialog" aria-label="시작 안내">
        <div class="oi-head">
          ...
          <div class="oi-sub">${n.span || "최근 공개분을 중심으로 한 "}감사원 공개문 <b>${n.doc}</b>건을 분석해 <b>${n.card}</b>장의 사례 카드로 분해 — 검색만 하면 실제 감사 사례의 착안점·선례·법령을 바로 확인합니다</div>
        </div>
        <div class="oi-pipe">
        ...
        <div class="trust">
          <div class="trust-mark">${koglMark()}<span class="trust-by">감사원 감사결과 공개자료</span></div>
          🛡️ <b>본 자료는 감사원이 대국민 공개한 감사결과 공개문만을 바탕으로 제작되었습니다.</b> · 100% 로컬 처리 · 외부 전송 없음<br><span style="font-size:12.5px;color:#5a6b7d">출처표시–상업적 이용금지–변경금지(공공누리 제4유형) · 원문은 <b>감사원(bai.go.kr)</b>에서 확인</span></div>
