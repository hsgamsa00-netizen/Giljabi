...
window.AnalysisTutorial = (function () {
  ...
  const STEPS = [
    ...
    },
    {
      ...
      lead: "표본이 적은 유형은 ‘<b>선례 갈림 — 판단 보류</b>’로 단정하지 않습니다. 모든 수치는 공개문 집계라 <b>인용 환각 0</b>, 입력→위반유형 매칭은 자동이라 <b>확인을 권합니다</b>. LLM 판단의 대체가 아니라, 선례를 빠르게 인출하는 도구입니다.",
      ex: `<div class="at-mc">원문·최종 판단은 <b>감사원(bai.go.kr)</b> 공개문에서 확인 · 이제 닫고 ‘착안점 찾기’에 직접 정황을 넣어 보세요.</div>`
    }
  ];
