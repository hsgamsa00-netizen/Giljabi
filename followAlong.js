  ...
  function rebutMock() {
    try {
      ...
      return `<div class="fa-real">
        <div class="frh dev">😈 다중관점 — 반대 선례로 상대 반론 미리 점검 (악마의 대변인 — 반대편 자처·약점 점검)</div>${devH}
        <div class="frh ask">🤔 되묻기 — 선례가 짚어준 확인 항목</div>${askH}
        <div class="frh crit">📝 비평 — 동반 위반(coOccur)</div><div class="fri">· ${coTop || "—"}</div>
        <div class="frc">계약·조달 ${base.length}건에서 실시간 인출 · 데이터 인용 환각 0</div></div>`;
    } catch (e) {
      return `<div class="at-row"><span class="at-tag dev">😈 면책 선례</span><span class="at-tag ask">🤔 결재선?</span><span class="at-tag crit">📝 검사·감독?</span></div><div class="at-mc">반대 방향 선례·되묻기·비평 (실데이터 인출)</div>`;
    }
  }

  const STEPS = [
    {
      t: "🗂️ 막막한 출발 — ‘어디서부터 보지?’", rlab: "📨 받은 제보",
      q: "□□시 <b>계약업무 감사</b>를 맡았다. ‘<b>수의계약 분할 발주</b>’ 제보가 있는데, 무엇부터 확인해야 할지 막막하다.",
      a: "감으로 들이대기 전에, <b>지적이 되는지·처분은 어디까지</b>인지부터 데이터로 가늠해 보기로 한다.",
      r: "막연한 불안을 ‘<b>확인할 질문</b>’으로 바꾸는 게 시작. 감사 길잡이를 연다.",
      mock: `<div class="at-mc">📨 제보: “5천만 원 공사를 <b>2천만 원씩 쪼개</b> 수의계약?” — 지적이 될까? 처분은?</div>`
    },
    {
      t: "📚 감사 길잡이를 열다", rlab: "🖥 프로그램 화면",
      q: "이 프로그램으로 뭘 할 수 있지?",
      a: "감사원이 <b>대국민 공개</b>한 감사결과를 사례 카드로 정리 — <b>검색만으로</b> 실제 감사 사례의 착안점·선례·법령을 본다.",
      r: "검색·분석은 모두 <b>내 기기에서 처리</b>(외부 전송 없음). 상단 3탭 중 막막할 땐 <b>분석</b>부터.",
      mock: `<div class="at-row"><span class="at-pill on">📊 분석</span><span class="at-pill">📂 사례 탐색</span><span class="at-pill">⭐ 내 사례함</span></div><div class="at-mc">상단 3개 탭으로 움직입니다.</div>`
    },
    {
      t: "📊 ① 분석 · 현황 — 데이터로 감 잡기", rlab: "📊 분석 화면",
    ...
    {
      t: "🎯 착안점 찾기 — 내 사안을 넣다", rlab: "🎯 착안점 결과",
      q: "내 사안을 직접 넣으면 비슷한 선례가 나올까?",
      a: "분석 → 착안점 찾기에 ‘<b>수의계약 분할 발주</b>’라고 그대로 입력하고 [찾기].",
      r: "유사 <b>643건</b> + 예상 처분 + 공통 착안점(분할 정황·동일업체·예정가격). “<b>이 셋을 현장에서 확인하면 되겠다.</b>”",
      mock: `<div class="at-input">수의계약 분할 발주<span class="at-cur">▏</span></div><div class="at-mc">유사 643건 · 주의 다수 · 착안점: 분할 정황 · 동일업체 · 예정가격 · 🚩 적신호</div>`
    },
    {
      t: "🔗 적발 관계망 — 옆에서 같이 터지는 것", rlab: "🔗 관계망 (수의계약 중심)",
      q: "수의계약만 보면 끝일까? <b>같이 적발되는 게</b> 있지 않을까?",
      a: "착안점 찾기의 <b>🔗 적발 관계망</b>을 ⤢ 크게 열고 ‘<b>수의계약</b>’ 노드를 누른다.",
      r: "‘수의계약’은 ‘<b>입찰·낙찰</b>’과 <b>104건</b>, ‘부정당·제재’와 18건 같이 적발. “<b>계약서만 보면 놓친다 — 낙찰 과정과 제재 이력까지 같이 보자.</b>” 마음에 든 착안점은 📝 메모에 담는다.",
      mock: `<div class="at-mc" style="line-height:2">⬤ <b>수의계약</b> ═══ 입찰·낙찰 <em>104</em> ─── 부정당·제재 <em>18</em> ─ 용역계약 <em>14</em></div><div class="at-mc">노드 클릭 → 대표 착안점·동반 주제 / 선 클릭 → 같이 적발된 실제 사례</div>`
    },
    {
      t: "🔍 반론·검증 — 반대편에서 한 번 더", rlab: "🔍 반론·검증 (실제 선례)", dyn: true,
    ...
    {
      t: "🔎 ② 사례 탐색 — 비슷한 선례를 직접", rlab: "🔎 탐색 결과",
      q: "통계 말고, 진짜 비슷한 사건의 처분요구서를 직접 보고 싶다.",
      a: "사례 탐색에서 분야 ‘<b>계약입찰</b>’ → ‘<b>계약·조달</b>’, 검색 ‘수의계약 분할’. (‘<b>주제·표식</b>’에서 세부 주제 ‘수의계약’으로도 가능)",
      r: "분할 수의계약 부적정 사례가 줄줄이. “<b>우리 사안이랑 판박이네.</b>” 양정·문구를 참고한다.",
      mock: `<div class="at-input">수의계약 분할<span class="at-cur">▏</span></div><div class="at-mc">계약입찰 › 계약·조달 + 검색 → 유사 사례 목록</div>`
    },
    {
      t: "📄 사례 상세 — 근거를 손에", rlab: "📄 사례 상세",
      ...
      mock: `<div class="at-qs"><div><b>위반사실</b> — 분할 수의계약으로 경쟁 회피</div><div><b>근거</b> 지방계약법 시행령 §25 · <b>근거 페이지 p.4·p.7</b> <span class="muted">(공개문 원문 쪽)</span></div><div>🚩 동일 업체 반복</div></div>`
    },
    {
      t: "⭐ ③ 담기 · ✏️ 메모 — 챙겨두기", rlab: "⭐ 챙긴 것",
      ...
      mock: `<div class="at-mc">☆ 담은 선례 · ✏️ 메모: “분할 시점 · 기안문 결재선 · 예정가격 산정 근거 확인”</div>`
    },
    {
      t: "✅ 도달 — 막막함이 근거가 되다", rlab: "📋 최종 정리",
      ...
      mock: `<div class="at-mc"><b>§위반 가능성 + 선례 + 양정 근거 + 점검 질문</b> → 처분요구서에 그대로. · 원문·최종 판단은 감사원(bai.go.kr) 공개문에서 확인.</div>`
    }
  ];
  ...
  function render() {
    ...
    body.innerHTML = `
      <div class="at-head fa">
        <div class="at-brand">✍️ 사례로 따라 하기 <span class="at-sub">‘수의계약 분할 발주’ 감사를 처음부터 끝까지</span></div>
      ...
      <div class="fa-body">
        <div class="fa-left">
          ...
          <div class="beat q"><div class="bt">💭 고민</div><div class="bd">${s.q}</div></div>
          <div class="beat a"><div class="bt">🖱 행동</div><div class="bd">${s.a}</div></div>
          <div class="beat r"><div class="bt">✅ 발견</div><div class="bd">${s.r}</div></div>
        </div>
        <div class="fa-right">
