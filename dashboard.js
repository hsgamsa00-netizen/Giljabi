...
window.Dashboard = (function () {
  ...
  const FLD = ["계약·조달", "재정·회계", "세무·징수", "보조금·기금", "인사·채용", "공유재산·물품", "인허가·개발", "환경·에너지", "복지·보건", "교통·물류", "도시·주택·건축", "농림·축산·수산", "산업·일자리", "안전·재난", "교육·평생학습", "정보·AI·디지털", "문화·관광·체육", "여성·가족·아동", "공공시설 관리·운영", "일반행정"];   // 20분야
