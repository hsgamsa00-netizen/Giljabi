...
window.FollowAlong = (function () {
  ...
  const STEPS = [
    ...
    },
    {
      ...
      r: "유사 <b>선례 다수</b> + 예상 처분 + 공통 착안점(분할 정황·동일업체·예정가격). “<b>이 셋을 현장에서 확인하면 되겠다.</b>”",
      mock: `<div class="at-input">수의계약 분할 발주<span class="at-cur">▏</span></div><div class="at-mc">유사 선례 다수 · 주의 다수 · 착안점: 분할 정황 · 동일업체 · 예정가격 · 🚩 적신호</div>`
    },
    {
      t: "🔗 적발 관계망 — 옆에서 같이 터지는 것", rlab: "🔗 관계망 (수의계약 중심)",
      q: "수의계약만 보면 끝일까? <b>같이 적발되는 게</b> 있지 않을까?",
      a: "착안점 찾기의 <b>🔗 적발 관계망</b>을 ⤢ 크게 열고 ‘<b>수의계약</b>’ 노드를 누른다.",
      r: "‘수의계약’은 ‘<b>입찰·낙찰</b>’·‘부정당·제재’와 자주 함께 적발. “<b>계약서만 보면 놓친다 — 낙찰 과정과 제재 이력까지 같이 보자.</b>” 마음에 든 착안점은 📝 메모에 담는다.",
