...
window.PanelGuide = (function () {
    ...
    digest: {
      ...
      steps: [
        ...
        },
        {
          ...
          ex: `<div class="at-qs"><div><b>위반사실</b> · <b>근거법령</b>(클릭→조문) · <b>근거 p.4·p.7</b></div><div><b>착안점</b> · <b>🚩 적신호</b> — 감사계획·점검에 바로 활용</div></div>`
        },
        {
          t: "⭐ 담기 · ✏️ 메모",
          lead: "사례 옆 <b>☆</b>를 누르면 <b>내 사례함</b>에 모입니다. 플로팅 메모로 현장 의견·착안점을 남길 수 있습니다 <span class=\"muted\">(이 기기에만 저장·외부 전송 없음)</span>.",
          ex: `<div class="at-mc">☆ 담기 → ⭐ 내 사례함 · ✏️ 메모는 첫 줄이 제목 · 모두 로컬 저장</div>`
        }
      ]
    },
    keep: {
  ...
  function open(topic) {
    ...
    ov.innerHTML = `<div class="at-modal" role="dialog" aria-label="${_brand}"></div>`;
